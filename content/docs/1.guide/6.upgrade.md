...
Kite 遵循语义化版本（[SemVer](https://semver.org/lang/zh-CN/)），发布节奏以 [GitHub Releases](https://github.com/amigoer/kite/releases) 为准。每次升级推荐按**备份 → 升级 → 校验 → 回滚预案**的顺序执行。
...
1. 查看 [Releases](https://github.com/amigoer/kite/releases) 的变更日志，特别关注：
...
- **GitHub Releases**：<https://github.com/amigoer/kite/releases.atom> 可直接订阅 RSS
